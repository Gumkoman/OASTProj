...
def generate_first_population(list_of_demands: list, population_size: int):
...
def crossover_chromosomes(original_population, best_fitness: float, crossover_probability_mul: float):
